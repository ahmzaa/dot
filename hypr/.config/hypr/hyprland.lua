...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("uwsm app -- /home/ahmza/bin/swp")
	hl.exec_cmd("uwsm app -- /home/ahmza/bin/launch-waybar")
	hl.exec_cmd("uwsm app -- hyprctl setcursor Bibata-Modern-Ice 24")
	...
	hl.exec_cmd("uwsm app -- flatpak run io.github.htkhiem.Euphonica")
...
-- Emoji Picker
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.exec_cmd("BEMOJI_PICKER_CMD='tofi' bemoji"))
...
hl.window_rule({
	...
	opacity = "0.9 override 0.8 override 0.9 override",
})
...
-- xwaylandbridge for screensharing fix
hl.window_rule({
	match = {
